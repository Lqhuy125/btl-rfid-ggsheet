...
const char *mainLinkForSpr = "https://script.google.com/macros/s/AKfycbwkqrVOX2MyoKiUAKy5wjESza5ixywgK0voh087XRIRoTpp4fYpYSPAr7q5_fIQQxKq/exec"; // test
...
void handleDataFromGoogle(String data)
{
  ...
  if(accessType.equalsIgnoreCase("-1")){
    lcd.setCursor(0,0);
    lcd.print(name);
    lcd.setCursor(0,1);
    lcd.print(text);
  ...
  else if(accessType.equalsIgnoreCase("ok")){
    lcd.setCursor(0,0);
    lcd.print("Hi ");
    lcd.print(name);
    lcd.setCursor(0,1);
